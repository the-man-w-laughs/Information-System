    ...
    public class PersonalInfoProfile : BaseProfile
    {
        public PersonalInfoProfile()
        {
            CreateMap<PersonalInfoRequestDto, PersonalInfoModel>()
                ...
                .ForMember(
                    dest => dest.PassportSeries,
                    opt => opt.MapFrom(src => src.PassportSeries)
                )
                .ForMember(
                ...
                .ForMember(
                    dest => dest.PassportIssuedBy,
                    opt => opt.MapFrom(src => src.PassportIssuedBy)
                )
                .ForMember(
                    dest => dest.PassportIssueDate,
                    opt => opt.MapFrom(src => src.PassportIssueDate)
                )
                .ForMember(
                ...
                .ForMember(
                    dest => dest.RegistrationCityId,
                    opt => opt.MapFrom(src => src.RegistrationCityId)
                )
                .ForMember(
                    dest => dest.MaritalStatusId,
                    opt => opt.MapFrom(src => src.MaritalStatusId)
                )
            ...
            CreateMap<PersonalInfoModel, PersonalInfoResponseDto>()
                ...
                .ForMember(dest => dest.CurrentCityId, opt => opt.MapFrom(src => src.CurrentCityId))
                .ForMember(
                    dest => dest.CurrentCity,
                    opt => opt.MapFrom(src => src.CurrentCity != null ? src.CurrentCity.Name : null)
                )
                .ForMember(
                    dest => dest.CurrentAddress,
                    opt => opt.MapFrom(src => src.CurrentAddress)
                ...
                .ForMember(
                    dest => dest.RegistrationCity,
                    opt =>
                        opt.MapFrom(
                            src => src.RegistrationCity != null ? src.RegistrationCity.Name : null
                        )
                )
                .ForMember(
                    dest => dest.MaritalStatusId,
                ...
                .ForMember(
                    ...
                    opt =>
                        opt.MapFrom(
                            src => src.MaritalStatus != null ? src.MaritalStatus.Name : null
                        )
                )
                .ForMember(dest => dest.CitizenshipId, opt => opt.MapFrom(src => src.CitizenshipId))
                .ForMember(
                    dest => dest.Citizenship,
                    opt => opt.MapFrom(src => src.Citizenship != null ? src.Citizenship.Name : null)
                )
                .ForMember(dest => dest.DisabilityId, opt => opt.MapFrom(src => src.DisabilityId))
                .ForMember(
                    dest => dest.Disability,
                    opt => opt.MapFrom(src => src.Disability != null ? src.Disability.Name : null)
                )
                .ForMember(dest => dest.IsPensioner, opt => opt.MapFrom(src => src.IsPensioner))
                .ForMember(
                    dest => dest.MonthlyIncome,
                    opt => opt.MapFrom(src => src.MonthlyIncome)
                );
        }
    }
}
