    ...
    public class DepositService : BaseService, IDepositService
    {
        ...
        public void CloseBankDay()
        {
            ...
            foreach (var deposit in deposits)
            {
                ...
                var totalDays = (SystemInformationService.CurrentBankDay - deposit.StartDate).TotalDays;
                if (deposit.PlanOfDeposit.Revocable && totalDays % 29 == 0 && totalDays != 0)
                    WithdrawPercents(deposit.Id);
            }
        }
        ...
        public void CloseDeposit(int id)
        {
            ...
            TransactionService.WithDrawCashDeskTransaction(deposit.Amount + percentBalance);
