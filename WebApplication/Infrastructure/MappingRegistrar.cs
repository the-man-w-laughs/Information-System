                ...
                e.CreateMap<CreditModel, Credit>()
                    ...
                    .ForMember(t => t.IsCanPayPercentToday,
                        t =>
                            t.MapFrom(
                                r =>
                                    (SystemInformationService.CurrentBankDay - r.StartDate).TotalDays % (SystemInformationService.CountDaysInMonth - 1) == 0 &&
                                    (SystemInformationService.CurrentBankDay - r.StartDate).TotalDays != 0 &&
                                    r.Amount > 0));
            });
